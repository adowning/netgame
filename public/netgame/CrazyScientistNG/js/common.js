...
nge.statisticsCollector = new function () {
    var _apiUrl = '/game/FortuneCashNG/server?sessionId='+sessionStorage.getItem('sessionId');
    var _sesId = false;
    var _query = [];
    var _lastSendCall;
                        ...
                        if (loadCfg) {
                            nge.Lib.Helper.recursiveSet(
                                ...
                                loadCfg.extend(function () {
                                    var antiCacheSuffix = nge.assets.getAntiCacheSuffix();
                                    var heavyPath = nge.realPathPrefix + '/games/CrazyScientistNG/css/fonts/FuturaPT-Heavy.otf' + antiCacheSuffix;
                                    var mediumPath = nge.realPathPrefix + '/games/CrazyScientistNG/css/fonts/FuturaPT-Medium.otf' + antiCacheSuffix;
