...
class OriginalResultsExtractor
{
    ...
    {
        // Get list of games that exist in both old/ and new/ folders
        ...
        // Create mock game data for common games
        $this->gameData = [];
    ...
    {
        // Create mock user and game data
        ...
        // Create mock POST data for spin request
        ...
        // Execute the original game server
    ...
    {
        // Create a temporary PHP script to execute the original server
        ...
        // Try to extract JSON response from output
        // The original server outputs in format: :::{"responseEvent":"spin",...}
        ...
        // Fallback: try to parse any JSON in the output
    ...
    private function createTempServerScript($gameName, $userId, $user, $game, $shop, $postData)
    {
        ...
        // Create mock Laravel classes and functions
        $mockCode = '<?php

// Mock Laravel classes and functions
class Auth {
...
// Include the original server
require_once "' . __DIR__ . '/old/' . $gameName . '/Server.php";

// Create server instance and execute
