...
class GameCalculator
{
    ...
    public function __construct($gameData)
    {
        ...
        $this->Paytable['SYM_2'] = [0, 0, 0, 40, 400, 200];
        $this->Paytable['SYM_3'] = [0, 0, 0, 15, 75, 500];
        $this->Paytable['SYM_4'] = [0, 0, 0, 10, 40, 250];
        $this->Paytable['SYM_5'] = [0, 0, 0, 5, 30, 100];
        $this->Paytable['SYM_6'] = [0, 0, 0, 4, 20, 75];
        $this->Paytable['SYM_7'] = [0, 0, 0, 4, 20, 75];
        $this->slotBonus = true;
        $this->slotWildMpl = 1;
        $this->slotFreeMpl = 1;
        $this->slotFreeCount = [
