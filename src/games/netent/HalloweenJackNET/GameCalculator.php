...
namespace App\Games\NetEnt\HalloweenJackNET;
...
class GameCalculator
{
    ...
    public function __construct($gameData)
    {
        ...
        $this->Paytable['SYM_3'] = [0, 0, 0, 20, 200, 1000];
        $this->Paytable['SYM_4'] = [0, 0, 0, 15, 100, 750];
        $this->Paytable['SYM_5'] = [0, 0, 0, 10, 50, 250];
        $this->Paytable['SYM_6'] = [0, 0, 0, 10, 50, 250];
        $this->Paytable['SYM_7'] = [0, 0, 0, 8, 30, 125];
        $this->Paytable['SYM_8'] = [0, 0, 0, 6, 25, 100];
        $this->Paytable['SYM_9'] = [0, 0, 0, 5, 20, 75];
        $this->Paytable['SYM_10'] = [0, 0, 0, 5, 20, 75];
        $this->Paytable['SYM_11'] = [0, 0, 0, 4, 15, 50];
        $this->Paytable['SYM_12'] = [0, 0, 0, 3, 10, 30];
